...
<head>
    ...
    <title>YourWay Trek - שאלון אפיון</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-3xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div class="bg-emerald-800 p-5 text-white text-center relative shrink-0">
            <div class="relative z-10">
                ...
                <p class="text-emerald-100 text-sm opacity-90">תכנון טרק בהתאמה אישית</p>
            </div>
            <!-- Decorative overlay -->
        ...
        <div class="bg-gray-50 px-6 py-3 border-b border-gray-100 shrink-0">
            <div class="flex justify-between text-xs text-gray-500 mb-2 font-bold">
                <span id="step-indicator">שלב 1: היכרות</span>
                <span>5 שלבים</span>
            </div>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8">
            ...
            <div id="step-1" class="step-content active space-y-6 animate-fadeIn">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">תכנון הטרק שלכם מתחיל כאן</h2>
                    <p class="text-gray-500">נעים להכיר! כמה פרטים בסיסיים כדי שנוכל לבנות את המסלול המושלם עבורכם.</p>
                </div>
                
                <!-- Side-by-side layout for large screens -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-2xl mx-auto">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">שם מלא</label>
                        <div class="relative">
                            <i data-lucide="user" class="absolute right-3 top-3.5 h-5 w-5 text-gray-400"></i>
                            <input type="text" id="input-name" class="w-full pr-10 pl-4 py-3 border-2 border-gray-200 rounded-xl outline-none transition-colors bg-gray-50 focus:bg-white" placeholder="ישראל ישראלי">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">טלפון נייד</label>
                        <div class="relative">
            ...
            <div id="step-2" class="step-content space-y-8 animate-fadeIn">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button onclick="setTravelerType('couple')" class="traveler-btn btn-option p-3 rounded-xl border-gray-200 text-gray-600 flex flex-col items-center gap-1" data-type="couple">
                                ...
                                <span class="font-bold text-sm">זוג</span>
                            </button>
                            <button onclick="setTravelerType('friends')" class="traveler-btn btn-option p-3 rounded-xl border-gray-200 text-gray-600 flex flex-col items-center gap-1" data-type="friends">
                                <span class="text-2xl">🥂</span>
                                <span class="font-bold text-sm">חברים</span>
                            </button>
                            <button onclick="setTravelerType('family')" class="traveler-btn btn-option p-3 rounded-xl border-gray-200 text-gray-600 flex flex-col items-center gap-1" data-type="family">
                                <span class="text-2xl">👨‍👩‍👧‍👦</span>
                                <span class="font-bold text-sm">משפחה</span>
                            </button>
                            <button onclick="setTravelerType('solo')" class="traveler-btn btn-option p-3 rounded-xl border-gray-200 text-gray-600 flex flex-col items-center gap-1" data-type="solo">
                                <span class="text-2xl">🏃</span>
                                <span class="font-bold text-sm">לבד</span>
                            </button>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 flex items-center justify-between h-[76px]">
                                <span class="font-bold text-gray-700">סה״כ מבוגרים</span>
                            ...
                            <div id="kids-section" class="hidden bg-orange-50 p-3 rounded-xl border border-orange-100 animate-fadeIn">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="font-bold text-orange-900 text-sm">ילדים (עד 3)</span>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 mb-5">
                        <div class="w-1/2">
                            <label class="block text-xs font-bold text-gray-500 mb-1">ימי הליכה (ברוטו)</label>
                            <div class="relative">
                                <select id="duration-select" onchange="updateNights()" class="w-full appearance-none bg-white border-2 border-gray-200 px-4 py-2.5 rounded-xl font-bold text-gray-700 outline-none focus:border-emerald-500 cursor-pointer">
                                    ...
                                    <option value="5" selected>5 ימים</option>
                        ...
                        <div class="w-1/2">
                            <label class="block text-xs font-bold text-gray-500 mb-1">סה״כ לילות</label>
                    ...
                    <div class="flex p-1 bg-gray-100 rounded-xl mb-4 max-w-sm">
                        <button onclick="setDateMode('flexible')" id="btn-date-flex" class="flex-1 py-1.5 rounded-lg text-sm font-bold transition-all shadow-sm bg-white text-emerald-700">אני זורם</button>
                        <button onclick="setDateMode('hard')" id="btn-date-hard" class="flex-1 py-1.5 rounded-lg text-sm font-bold transition-all text-gray-500 hover:text-gray-700">טווח קשיח</button>
                    </div>

                    <div id="date-input-flexible" class="animate-fadeIn">
                        <textarea id="date-text" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 outline-none resize-none h-20 text-sm" placeholder="למשל: ספטמבר עדיף, אבל גמישים גם ליולי..."></textarea>
                    </div>

                    <div id="date-input-hard" class="hidden animate-fadeIn space-y-3">
                         <div class="grid grid-cols-2 gap-4">
                             <div>
                                 <span class="text-xs text-gray-500 mb-1 block font-bold">מאיזה תאריך</span>
                             ...
                             <div>
                                 <span class="text-xs text-gray-500 mb-1 block font-bold">עד איזה תאריך</span>
            ...
            <div id="step-3" class="step-content space-y-8 animate-fadeIn">
                <h2 class="text-xl font-bold text-gray-800 mb-6 text-center">סגנון הטרק</h2>

                <!-- Experience -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-3">מה הניסיון שלכם?</label>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button onclick="setSingleSelect('experience', 'first-time')" class="select-btn-experience btn-option w-full p-4 rounded-xl bg-white border-gray-200 text-right group" data-value="first-time">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-bold text-lg">טרק ראשון</span>
                            </div>
                            <p class="text-sm text-gray-500 text-muted pr-4">טיילנו בעבר, אבל לא בטרק רב-יומי מתגלגל.</p>
                        </button>
                        ...
                        <button onclick="setSingleSelect('experience', 'experienced')" class="select-btn-experience btn-option w-full p-4 rounded-xl bg-white border-gray-200 text-right group" data-value="experienced">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-bold text-lg">מנוסים</span>
                            </div>
                            <p class="text-sm text-gray-500 text-muted pr-4">מכירים את השגרה של הליכה יום אחרי יום.</p>
                        </button>
                    </div>
                </div>
                ...
                <!-- Pace -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-3">קצב הליכה מועדף (נטו)</label>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <button onclick="setSingleSelect('pace', 'easy')" class="select-btn-pace btn-option w-full p-4 rounded-xl bg-white border-gray-200 flex flex-col items-center text-center gap-2" data-value="easy">
                            ...
                            <div>
                                <div class="font-bold text-base">רגוע (4-5)</div>
                                <div class="text-xs text-gray-500 text-muted leading-tight mt-1">זמן לקפה, מנוחה ונוף</div>
                            </div>
                        </button>
                        <button onclick="setSingleSelect('pace', 'classic')" class="select-btn-pace btn-option w-full p-4 rounded-xl bg-white border-gray-200 flex flex-col items-center text-center gap-2" data-value="classic">
                            ...
                            <div>
                                <div class="font-bold text-base">קלאסי (5-7)</div>
                                <div class="text-xs text-gray-500 text-muted leading-tight mt-1">הסטנדרט המקובל</div>
                            </div>
                        </button>
                        <button onclick="setSingleSelect('pace', 'intense')" class="select-btn-pace btn-option w-full p-4 rounded-xl bg-white border-gray-200 flex flex-col items-center text-center gap-2" data-value="intense">
                            ...
                            <div>
                                <div class="font-bold text-base">אינטנסיבי (7+)</div>
                                <div class="text-xs text-gray-500 text-muted leading-tight mt-1">לקום מוקדם וללכת</div>
                            </div>
                        </button>
                    </div>
                </div>
                ...
                <label class="flex items-center gap-4 p-4 bg-blue-50 rounded-xl border border-blue-100 cursor-pointer hover:bg-blue-100 transition-colors">
                    ...
                    <div class="text-sm text-gray-800">
                        <span class="font-bold block mb-1">פתוחים לאתגרים טכניים?</span>
                        מוכנים לשלב סולמות, כבלים או יתדות (לא לסובלים מפחד גבהים).
                    </div>
                </label>
            </div>
            ...
            <div id="step-4" class="step-content space-y-8 animate-fadeIn">
                <h2 class="text-xl font-bold text-gray-800 mb-6 text-center">לינה ולוגיסטיקה</h2>

                <!-- Accommodation -->
                <div>
                    <div class="flex justify-between items-end mb-3">
                        <label class="block text-sm font-bold text-gray-700">העדפות לינה</label>
                        <span class="text-xs text-emerald-700 bg-emerald-100 px-2 py-1 rounded-md font-medium">ניתן לבחור שילובים</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <button onclick="toggleMultiSelect('accom', 'dorms')" class="select-btn-accom btn-option w-full p-4 rounded-xl bg-white border-gray-200 text-right flex items-start gap-4" data-value="dorms">
                            ...
                            <div class="flex-1">
                                <div class="font-bold text-base">דורמיטורי (משותף)</div>
                                <div class="text-xs text-gray-500 text-muted">חווית בקתה אמיתית וזולה.</div>
                            </div>
                        ...
                        <button onclick="toggleMultiSelect('accom', 'private-hut')" class="select-btn-accom btn-option w-full p-4 rounded-xl bg-white border-gray-200 text-right flex items-start gap-4" data-value="private-hut">
                            ...
                            <div class="flex-1">
                                <div class="font-bold text-base">חדר פרטי בבקתה</div>
                                <div class="text-xs text-gray-500 text-muted">עם מקלחת משותפת או בתוך החדר.</div>
                            </div>
                            <i data-lucide="check-circle" class="w-6 h-6 text-white opacity-0 check-icon transition-opacity"></i>
                        </button>
                        ...
                        <button onclick="toggleMultiSelect('accom', 'hotel-valley')" class="select-btn-accom btn-option w-full p-4 rounded-xl bg-white border-gray-200 text-right flex items-start gap-4" data-value="hotel-valley">
                            ...
                            <div class="flex-1">
                                <div class="font-bold text-base">מלונות בעמקים</div>
                                <div class="text-xs text-gray-500 text-muted">ירידה מההר למלון מפנק בסוף יום.</div>
                            </div>
                            <i data-lucide="check-circle" class="w-6 h-6 text-white opacity-0 check-icon transition-opacity"></i>
                        </button>
                        ...
                        <button onclick="toggleMultiSelect('accom', 'whatever')" class="select-btn-accom btn-option w-full p-4 rounded-xl bg-gray-50 border-gray-300 border-dashed text-right flex items-center gap-4" data-value="whatever">
                            ...
                            <div class="flex-1 font-bold text-gray-700">כל מה שצריך כדי שזה יקרה!</div>
                            <i data-lucide="check-circle" class="w-6 h-6 text-white opacity-0 check-icon transition-opacity"></i>
                        </button>
                    </div>
                </div>
                ...
                <!-- Transport -->
                <div class="space-y-5">
                    <label class="block text-sm font-bold text-gray-700">לוגיסטיקה</label>
                    ...
                    <div class="flex gap-4">
                        <button onclick="setSingleSelect('luggage', 'false')" class="select-btn-luggage btn-option flex-1 p-4 rounded-xl bg-white border-gray-200 flex flex-col items-center gap-2" data-value="false">
                            ...
                            <span class="font-bold text-sm">הכל על הגב</span>
                        </button>
                        <button onclick="setSingleSelect('luggage', 'true')" class="select-btn-luggage btn-option flex-1 p-4 rounded-xl bg-white border-gray-200 flex flex-col items-center gap-2" data-value="true">
                            ...
                            <span class="font-bold text-sm">הקפצת ציוד</span>
                        </button>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
                        <label class="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer border border-transparent hover:border-gray-200">
                            ...
                            <span class="text-sm font-medium text-gray-700">מעוניינים בשימוש ברכבלים</span>
                        </label>
                        <label class="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer border border-transparent hover:border-gray-200">
                            <input type="checkbox" id="public-transport">
                            <span class="text-sm font-medium text-gray-700">מוכנ.ה לשימוש בתחבורה ציבורית</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div id="step-5" class="step-content space-y-8 animate-fadeIn">
                <h2 class="text-xl font-bold text-gray-800 mb-6 text-center">סיום ודגשים אחרונים</h2>

                <!-- Diet -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
                        <i data-lucide="utensils" class="w-4 h-4"></i> דגשי תזונה
                    </label>
                    <div class="flex flex-wrap gap-2 mb-3">
                        <button onclick="toggleDiet(this)" class="diet-btn btn-option px-4 py-2 rounded-full text-sm bg-white border-gray-200 text-gray-600" data-val="צמחוני">צמחוני</button>
                        <button onclick="toggleDiet(this)" class="diet-btn btn-option px-4 py-2 rounded-full text-sm bg-white border-gray-200 text-gray-600" data-val="טבעוני">טבעוני</button>
                        <button onclick="toggleDiet(this)" class="diet-btn btn-option px-4 py-2 rounded-full text-sm bg-white border-gray-200 text-gray-600" data-val="כשר">כשר</button>
                        <button onclick="toggleDiet(this)" class="diet-btn btn-option px-4 py-2 rounded-full text-sm bg-white border-gray-200 text-gray-600" data-val="ללא גלוטן">ללא גלוטן</button>
                        <button onclick="toggleDiet(this)" class="diet-btn btn-option px-4 py-2 rounded-full text-sm bg-white border-gray-200 text-gray-600" data-val="אחר">אחר...</button>
                    </div>
                    <div id="diet-other-container" class="hidden mt-2 animate-fadeIn">
                        <input type="text" id="diet-other" class="w-full p-3 border-2 border-emerald-100 rounded-xl focus:border-emerald-500 outline-none text-sm bg-emerald-50" placeholder="פרט/י את הרגישות או הדרישה המיוחדת...">
                    </div>
                </div>

                <!-- Notes -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">הערות וחלומות</label>
                    <div class="bg-yellow-50 p-3 rounded-xl text-xs text-yellow-800 mb-3 flex items-start gap-2 border border-yellow-100">
                        ...
                        כאן המקום לפרט כל דבר נוסף: גילאי הילדים, בקשות מיוחדות, בעיות רפואיות, או חלומות קטנים.
                    </div>
                    <textarea id="notes" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 outline-none h-32 resize-none text-base transition-all" placeholder="הערות חופשיות..."></textarea>
                </div>
            </div>
            ...
            <div id="error-screen" class="hidden flex flex-col items-center justify-center text-center py-10 animate-fadeIn h-full">
                ...
                <h2 class="text-2xl font-bold text-gray-800 mb-2">אופס... משהו השתבש</h2>
                <p class="text-gray-600 mb-6">
                   לא הצלחנו לשלוח את הפרטים.<br>
                   אנא נסו שוב או צרו קשר ישירות בוואטספ.
                </p>
                <button onclick="location.reload()" class="px-8 py-3 bg-gray-800 text-white rounded-full font-bold hover:bg-gray-900 transition-colors">נסה שוב</button>
            </div>
        ...
        <div id="footer-nav" class="p-5 border-t border-gray-100 bg-white flex justify-between items-center shrink-0 z-20">
            ...
            <button onclick="nextStep()" id="btn-next" class="flex items-center gap-2 px-10 py-3.5 rounded-full font-bold text-lg shadow-lg shadow-emerald-100 transition-all transform hover:scale-[1.02] active:scale-95 bg-emerald-600 hover:bg-emerald-700 text-white disabled:bg-gray-300 disabled:shadow-none disabled:cursor-not-allowed" disabled>
                <span id="btn-next-text">המשך</span>
    ...
    <script>
        ...
        function updateUI() {
            ...
            const titles = ["היכרות", "מי ומתי", "סגנון הטרק", "לוגיסטיקה", "סיום"];
            document.getElementById('step-indicator').textContent = `שלב ${currentStep}: ${titles[currentStep-1]}`;
            ...
            if (currentStep === totalSteps) {
                btnNextText.textContent = "שלח פרטים";
                btnNextIcon.setAttribute('data-lucide', 'send');
            } else {
                btnNextText.textContent = "המשך";
        ...
        function renderKidsAgeInputs() {
            ...
            for (let i = 0; i < formData.kidsCount; i++) {
                ...
                div.innerHTML = `
                    <span class="text-sm text-gray-600 w-16">גיל ילד ${i+1}:</span>
                    <input type="number" class="kids-age-input flex-1 p-2 border border-orange-200 rounded-lg text-sm focus:border-orange-500 outline-none" placeholder="גיל">
                `;
        ...
        function updateNights() {
            ...
            document.getElementById('nights-display').textContent = `${days - 1} לילות`;
        }
        ...
        function toggleDiet(btn) {
            ...
            if(formData.diets.includes('אחר')) {
